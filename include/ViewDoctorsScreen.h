#ifndef VIEWDOCTORSSCREEN_H
#define VIEWDOCTORSSCREEN_H
...
class ViewDoctorsScreen : public BaseScreen
{
private:
    sf::Font m_font;
...
public:
    ViewDoctorsScreen(MediCoreSystem& backend, ScreenManager& screenManager, const char* fontFilePath);
