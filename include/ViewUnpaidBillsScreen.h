#ifndef VIEWUNPAIDBILLSSCREEN_H
#define VIEWUNPAIDBILLSSCREEN_H
...
class ViewUnpaidBillsScreen : public BaseScreen
{
private:
    sf::Font m_font;
...
public:
    ViewUnpaidBillsScreen(MediCoreSystem& backend, ScreenManager& screenManager, const char* fontFilePath);
