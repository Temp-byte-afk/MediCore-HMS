#ifndef VIEWPATIENTSSCREEN_H
#define VIEWPATIENTSSCREEN_H
...
class ViewPatientsScreen : public BaseScreen
{
private:
    sf::Font m_font;
...
public:
    ViewPatientsScreen(MediCoreSystem& backend, ScreenManager& screenManager, const char* fontFilePath);
