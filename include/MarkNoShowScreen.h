#ifndef MARKNOSHOWSCREEN_H
#define MARKNOSHOWSCREEN_H
...
class MarkNoShowScreen : public BaseScreen
{
private:
    sf::Font m_font;
...
public:
    MarkNoShowScreen(MediCoreSystem& backend, ScreenManager& screenManager, const char* fontFilePath);
