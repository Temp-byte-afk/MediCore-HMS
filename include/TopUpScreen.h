#ifndef TOPUPSCREEN_H
#define TOPUPSCREEN_H
...
class TopUpScreen : public BaseScreen
{
private:
    sf::Font m_font;
...
public:
    TopUpScreen(MediCoreSystem& backend, ScreenManager& screenManager, const char* fontFilePath);
